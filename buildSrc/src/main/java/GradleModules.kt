...
val projectDirectory: String = java.io.File("").absolutePath
val scriptsPath = "$projectDirectory/$scriptsFolder"
const val buildFilePath = "$scriptsFolder/main.gradle.kts"
